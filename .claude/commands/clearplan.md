...
**IMPORTANT: This command is user-initiated only. Claude must never call `/clearplan` automatically.** It permanently deletes all existing plan files. Only proceed because the user explicitly invoked this command.

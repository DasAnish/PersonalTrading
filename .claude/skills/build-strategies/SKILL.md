...
1. Read all files in `strategy_definitions/` to understand what already exists
...
- If a strategy requires data or assets not in the system (e.g. bonds, equities outside the 4 ETFs), skip it

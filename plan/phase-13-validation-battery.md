...
## TODOs
- [ ] `analytics/validation.py` (<350 lines) —
...
- [ ] `scripts/validate_strategy.py` — `--strategy` (required), `--n-trials` (default from
      ...
      table + overall.
- [ ] `tests/test_validation.py` — battery on synthetic saved strategy (tmp results dir),

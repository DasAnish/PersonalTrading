...
## TODOs
- [ ] `.claude/commands/build-strategies.md` — strategist stage: read `research/backlog.md`
...
- [ ] Same file — analyst stage: replace run_overfitting.py call with
...
- [ ] Same file — orchestrator loop: on PASS/WARN with research_ref, update idea file status
...
- [ ] Dashboard: validation battery card in `scripts/server/templates/strategy.html` +
...
- [ ] Docs: `docs/overfitting.md` "Validation battery" section; `docs/strategies.md`
